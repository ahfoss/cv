...
\section{Experience}
 ...
 \begin{itemize} \itemsep -2pt
  \item Developed optimal statistical procedures for analyzing user satisfaction data
  \item Wrote and deployed a suite of high performance algorithms for analyzing satisfaction data in internal analysis tools
  \item Gave a talk introducing and justifying these testing procedures to 20+ Google user experience researchers across multiple Google locations
 \end{itemize}
...
\textbf{Familiar} (\textit{I can use at a high level while consulting references}): \\
  C, Go, HTML/CSS, Mathematica, Processing, SAS, SQL, Visual Basic
